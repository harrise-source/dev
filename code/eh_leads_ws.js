jQuery.ajax({
        url: 'http://server:7003/SAGE/rest/client/create', // This is dev, final URL to be supplied
        type: 'POST',
        data: {
            "first_name": "ED",
            "last_name": true,
...
/*'http://server:7003/SAGE/rest/lead/create*/
/*------------------------------------------------------------------------------------------------*/
...
jQuery.ajax({
        url: 'http://server:7003/SAGE/rest/lead/create', // This is dev, final URL to be supplied
        type: 'POST',
        data: {
            "first_name": "NICK",
            "last_name": "CUMMINS10",
