...
prompt APPLICATION 101 - Bootstrap Demo
--
-- Application Export:
--   Application:     101
--   Name:            Bootstrap Demo
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Bootstrap Demo')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_101')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'7BCCD6638B689C4A408DA74467BA896543D2A269A5D709D2E5408A46FA53983A'
...
,p_authentication_id=>wwv_flow_api.id(2887210554187766)
,p_application_tab_set=>0
,p_logo_image=>'TEXT:Bootstrap Demo'
...
,p_last_upd_yyyymmddhh24miss=>'20140814220155'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(111667762413142)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2876118372187723)
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(2887131400187762)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(2888600890187781)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_HOME'
,p_tab_text=>'Home'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(2888311169187778)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(2888720139187782)
,p_parent_id=>0
,p_short_name=>'Home'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876217106187726)
,p_theme_id=>26
,p_name=>'Login'
,p_is_popup=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876312230187728)
,p_theme_id=>26
,p_name=>'Minimal Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876423033187729)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876517255187729)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876609103187729)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876722804187729)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876828044187730)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2876929739187730)
,p_theme_id=>26
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877032636187730)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877128213187731)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877203269187731)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877313398187731)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877420841187731)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877526254187731)
,p_theme_id=>26
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877600088187732)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877716606187732)
,p_theme_id=>26
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877806585187733)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2877915998187733)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2878029871187733)
,p_theme_id=>26
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2889415368225698)
,p_theme_id=>25
,p_name=>'Login'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2889703682225699)
,p_page_template_id=>wwv_flow_api.id(2889415368225698)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2890023465225700)
,p_theme_id=>25
,p_name=>'No Tabs - Left Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2890401420225700)
,p_page_template_id=>wwv_flow_api.id(2890023465225700)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2890821751225700)
,p_page_template_id=>wwv_flow_api.id(2890023465225700)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2891208503225700)
,p_page_template_id=>wwv_flow_api.id(2890023465225700)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2891611825225700)
,p_page_template_id=>wwv_flow_api.id(2890023465225700)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2892009889225700)
,p_page_template_id=>wwv_flow_api.id(2890023465225700)
,p_name=>'Header'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2892306313225700)
,p_theme_id=>25
,p_name=>'No Tabs - Left and Right Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2892716762225701)
,p_page_template_id=>wwv_flow_api.id(2892306313225700)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2893124658225701)
,p_page_template_id=>wwv_flow_api.id(2892306313225700)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2893530502225701)
,p_page_template_id=>wwv_flow_api.id(2892306313225700)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2893918637225701)
,p_page_template_id=>wwv_flow_api.id(2892306313225700)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2894319281225701)
,p_page_template_id=>wwv_flow_api.id(2892306313225700)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2894728789225701)
,p_page_template_id=>wwv_flow_api.id(2892306313225700)
,p_name=>'Right Column'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2895031562225701)
,p_theme_id=>25
,p_name=>'No Tabs - No Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2895408905225702)
,p_page_template_id=>wwv_flow_api.id(2895031562225701)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2895832539225702)
,p_page_template_id=>wwv_flow_api.id(2895031562225701)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2896215837225702)
,p_page_template_id=>wwv_flow_api.id(2895031562225701)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2896604106225702)
,p_page_template_id=>wwv_flow_api.id(2895031562225701)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2896908688225702)
,p_theme_id=>25
,p_name=>'No Tabs - Right Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2897303307225702)
,p_page_template_id=>wwv_flow_api.id(2896908688225702)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2897723146225702)
,p_page_template_id=>wwv_flow_api.id(2896908688225702)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2898115748225703)
,p_page_template_id=>wwv_flow_api.id(2896908688225702)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2898530132225703)
,p_page_template_id=>wwv_flow_api.id(2896908688225702)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2898925991225703)
,p_page_template_id=>wwv_flow_api.id(2896908688225702)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2899208024225703)
,p_theme_id=>25
,p_name=>'One Level Tabs - Content Frame'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2899615304225703)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2900023781225703)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2900430924225703)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2900818392225703)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
,p_name=>'Side Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2901201436225704)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2901626913225704)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2902012385225704)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2902423299225704)
,p_page_template_id=>wwv_flow_api.id(2899208024225703)
,p_name=>'Icon Nav Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2902717948225705)
,p_theme_id=>25
,p_name=>'One Level Tabs - Left Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2903113261225705)
,p_page_template_id=>wwv_flow_api.id(2902717948225705)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2903519824225705)
,p_page_template_id=>wwv_flow_api.id(2902717948225705)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2903918597225706)
,p_page_template_id=>wwv_flow_api.id(2902717948225705)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2904305861225706)
,p_page_template_id=>wwv_flow_api.id(2902717948225705)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2904730292225706)
,p_page_template_id=>wwv_flow_api.id(2902717948225705)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2905104297225706)
,p_page_template_id=>wwv_flow_api.id(2902717948225705)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2905521787225706)
,p_page_template_id=>wwv_flow_api.id(2902717948225705)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2905823252225706)
,p_theme_id=>25
,p_name=>'One Level Tabs - Left and Right Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2906211005225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2906627326225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2907026148225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2907412815225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2907832078225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2908224314225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Page Level Tabs'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2908607701225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2909011875225707)
,p_page_template_id=>wwv_flow_api.id(2905823252225706)
,p_name=>'Icon Nav Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2909327515225707)
,p_theme_id=>25
,p_name=>'One Level Tabs - No Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2909704584225708)
,p_page_template_id=>wwv_flow_api.id(2909327515225707)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2910107292225708)
,p_page_template_id=>wwv_flow_api.id(2909327515225707)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2910505339225708)
,p_page_template_id=>wwv_flow_api.id(2909327515225707)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2910908225225708)
,p_page_template_id=>wwv_flow_api.id(2909327515225707)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2911316723225708)
,p_page_template_id=>wwv_flow_api.id(2909327515225707)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2911714342225709)
,p_page_template_id=>wwv_flow_api.id(2909327515225707)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2912013793225709)
,p_theme_id=>25
,p_name=>'One Level Tabs - Right Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2912412593225709)
,p_page_template_id=>wwv_flow_api.id(2912013793225709)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2912817407225709)
,p_page_template_id=>wwv_flow_api.id(2912013793225709)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2913211341225709)
,p_page_template_id=>wwv_flow_api.id(2912013793225709)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2913605600225709)
,p_page_template_id=>wwv_flow_api.id(2912013793225709)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2914000819225709)
,p_page_template_id=>wwv_flow_api.id(2912013793225709)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2914428086225710)
,p_page_template_id=>wwv_flow_api.id(2912013793225709)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2914831052225710)
,p_page_template_id=>wwv_flow_api.id(2912013793225709)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2915131512225710)
,p_theme_id=>25
,p_name=>'One Level Tabs - Wizard Page'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2915511684225710)
,p_page_template_id=>wwv_flow_api.id(2915131512225710)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2915924469225710)
,p_page_template_id=>wwv_flow_api.id(2915131512225710)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2916302690225710)
,p_page_template_id=>wwv_flow_api.id(2915131512225710)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2916708914225711)
,p_page_template_id=>wwv_flow_api.id(2915131512225710)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2917011756225711)
,p_page_template_id=>wwv_flow_api.id(2915131512225710)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2917418604225711)
,p_page_template_id=>wwv_flow_api.id(2915131512225710)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2917803159225711)
,p_page_template_id=>wwv_flow_api.id(2915131512225710)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2918116980225711)
,p_theme_id=>25
,p_name=>'Popup'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2918512593225711)
,p_page_template_id=>wwv_flow_api.id(2918116980225711)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2918808891225711)
,p_theme_id=>25
,p_name=>'Printer Friendly'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2919217546225712)
,p_page_template_id=>wwv_flow_api.id(2918808891225711)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2919615639225712)
,p_page_template_id=>wwv_flow_api.id(2918808891225711)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2920027607225712)
,p_page_template_id=>wwv_flow_api.id(2918808891225711)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2920420667225712)
,p_page_template_id=>wwv_flow_api.id(2918808891225711)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2920706500225712)
,p_theme_id=>25
,p_name=>'Two Level Tabs - Left Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2921125068225713)
,p_page_template_id=>wwv_flow_api.id(2920706500225712)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2921519304225713)
,p_page_template_id=>wwv_flow_api.id(2920706500225712)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2921910645225713)
,p_page_template_id=>wwv_flow_api.id(2920706500225712)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2922317256225713)
,p_page_template_id=>wwv_flow_api.id(2920706500225712)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2922703356225714)
,p_page_template_id=>wwv_flow_api.id(2920706500225712)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2923111388225714)
,p_page_template_id=>wwv_flow_api.id(2920706500225712)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2923513166225714)
,p_page_template_id=>wwv_flow_api.id(2920706500225712)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2923802433225714)
,p_theme_id=>25
,p_name=>'Two Level Tabs - Left and Right Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2924227255225715)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2924605094225715)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Left Column'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2925003780225715)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITON_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2925421575225715)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITON_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2925811073225715)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITON_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2926220153225715)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITON_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2926606603225715)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITON_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2927013506225716)
,p_page_template_id=>wwv_flow_api.id(2923802433225714)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITON_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2927305417225716)
,p_theme_id=>25
,p_name=>'Two Level Tabs - No Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2927712375225716)
,p_page_template_id=>wwv_flow_api.id(2927305417225716)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2928127458225716)
,p_page_template_id=>wwv_flow_api.id(2927305417225716)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2928502352225717)
,p_page_template_id=>wwv_flow_api.id(2927305417225716)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2928915713225717)
,p_page_template_id=>wwv_flow_api.id(2927305417225716)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2929319638225717)
,p_page_template_id=>wwv_flow_api.id(2927305417225716)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2929710142225717)
,p_page_template_id=>wwv_flow_api.id(2927305417225716)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2930006336225717)
,p_theme_id=>25
,p_name=>'Two Level Tabs - Right Sidebar'
,p_is_popup=>false
,p_javascript_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2930422654225717)
,p_page_template_id=>wwv_flow_api.id(2930006336225717)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2930800645225718)
,p_page_template_id=>wwv_flow_api.id(2930006336225717)
,p_name=>'Breadcrumb'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2931228452225718)
,p_page_template_id=>wwv_flow_api.id(2930006336225717)
,p_name=>'Right Column'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2931619000225718)
,p_page_template_id=>wwv_flow_api.id(2930006336225717)
,p_name=>'Footer'
,p_placeholder=>'REGION_POSITION_05'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2932031327225718)
,p_page_template_id=>wwv_flow_api.id(2930006336225717)
,p_name=>'Page Level Tabs'
,p_placeholder=>'REGION_POSITION_06'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2932427516225718)
,p_page_template_id=>wwv_flow_api.id(2930006336225717)
,p_name=>'Header'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(2932822635225718)
,p_page_template_id=>wwv_flow_api.id(2930006336225717)
,p_name=>'Icon Nav Bar'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>false
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2950411821243540)
,p_theme_id=>101
,p_name=>'Justified Nav'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2950907497280197)
,p_theme_id=>101
,p_name=>'Justified Nav..2'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">',
'<meta http-equiv="x-ua-compatible" content="IE=edge" />',
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2951116154282641)
,p_theme_id=>25
,p_name=>'Justified Nav'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(113459913413205)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2885329235187748)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2885413820187749)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2885506395187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2885607876187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2885709581187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2885825150187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2885913853187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2886006087187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2886124189187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2886206751187750)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2948329732225725)
,p_template_name=>'Button'
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2948510646225725)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2948728795225725)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2948902483225726)
,p_template_name=>'Large Button'
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2949122679225726)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(2949302720225726)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878128051187734)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878204991187737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878332303187737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878402603187737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878518825187737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878609945187737)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878728318187738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878830879187738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2878916328187738)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879005261187739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879110473187739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879225098187739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879300055187739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879405859187739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879527609187739)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879612437187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uBorderlessRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879715558187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879829634187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2879925520187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880007117187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880101755187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880215374187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880320532187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880412578187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880522784187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880613377187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880713563187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880831648187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2880906346187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2881008776187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2881132761187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2881209964187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2881307436187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2881431904187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2881521065187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2881614722187740)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2933120119225718)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2933402310225718)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uWhiteRegion uAlertRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2933710690225719)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uBorderlessRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2934006945225719)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2934311614225719)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2934605260225719)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uButtonRegionContentContainer">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2934909413225719)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'#SUB_REGION_HEADERS#',
'#BODY#',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2935227192225719)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#"> ',
'#BODY#',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2935530260225719)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2935918615225719)
,p_plug_template_id=>wwv_flow_api.id(2935530260225719)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2936209492225720)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2936512463225720)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uHideShowRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2936807950225720)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uIRRegion" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">',
'  <h1 class="visuallyhidden">#TITLE#</h1>',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2937108982225720)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2937510478225720)
,p_plug_template_id=>wwv_flow_api.id(2937108982225720)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2937804433225720)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uNoHeading #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionContent clearfix">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2938108044225721)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2938418217225721)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2938802199225721)
,p_plug_template_id=>wwv_flow_api.id(2938418217225721)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2939222152225721)
,p_plug_template_id=>wwv_flow_api.id(2938418217225721)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2939507017225721)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<section class="uRegion uRegionNoPadding #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="uRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2939800963225721)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<div class="cWizardButtons cWizardButtonsLeft">',
'#PREVIOUS##CLOSE#',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2882829234187743)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2882915536187744)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883007583187744)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883100749187744)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883214231187744)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883318442187745)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883408601187745)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883517455187745)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883628894187745)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883711178187745)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883804145187745)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2883907634187745)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2884027246187745)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2884116586187745)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2884231710187746)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2884325176187746)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2884407718187746)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2884515421187746)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2884628039187746)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2943424664225723)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2943718455225723)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<li>',
'  <a href="#LINK#">',
'    <h3>#TEXT#</h3>',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2944020662225723)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2944316282225723)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li> '
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li> '
,p_list_template_name=>'Horizontal Links List'
,p_theme_id=>25
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2944603109225724)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'    <li class="#LIST_STATUS#">',
'      <span>#TEXT#</span>',
'    </li>'))
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2944917541225724)
,p_list_template_current=>'<li><a href="#LINK#" class="active">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Page Level Tabs List'
,p_theme_id=>25
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2945226958225724)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Tabbed Navigation List'
,p_theme_id=>25
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2945513409225724)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'    <li class="active">',
'      <a href="#LINK#">',
'        <img src="#IMAGE_PREFIX##IMAGE#" #IMAGE_ATTR# alt="" />',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2945829486225724)
,p_list_template_current=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'  <li>',
'    <a href="#LINK#">',
'      <img src="#IMAGE_PREFIX#f_spacer.gif" class="#A02#" alt="#LIST_LABEL#"/>',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2946104645225724)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Ordered List'
,p_theme_id=>25
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2946416390225724)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Sidebar List'
,p_theme_id=>25
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2946714550225724)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List with Bullets'
,p_theme_id=>25
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2947016287225724)
,p_list_template_current=>'<li class="active"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_name=>'Vertical Unordered List without Bullets'
,p_theme_id=>25
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(2947319396225724)
,p_list_template_current=>'<li class="#LIST_STATUS#"><img src="#IMAGE_PREFIX#f_spacer.gif" alt="" /><span>#TEXT#</span></li>'
,p_list_template_noncurrent=>'<li class="#LIST_STATUS#"><img src="#IMAGE_PREFIX#f_spacer.gif" alt="" /><span>#TEXT#</span></li>'
,p_list_template_name=>'Wizard Progress List - Vertical'
,p_theme_id=>25
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2881701085187741)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2881814001187741)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2881922328187741)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882016941187741)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882126407187741)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882209834187741)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882321912187742)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882405319187742)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882513266187742)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882616159187742)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2882726435187742)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2940119939225721)
,p_row_template_name=>'Borderless Report'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<table class="uReportContainer uBorderlessReportContainer" #REPORT_ATTRIBUTES# id="report_#REGION_STATIC_ID#" summary="">',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2940430633225721)
,p_row_template_name=>'Comment Bubbles'
,p_row_template1=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<li class="#1#">',
'<div>',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2940706276225722)
,p_row_template_name=>'Fixed Headers'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" #COLUMN_WIDTH#>#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<table class="uReportContainer" #REPORT_ATTRIBUTES# id="report_#REGION_STATIC_ID#" summary="">',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2941007688225722)
,p_row_template_name=>'Horizontal Border'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<table class="uReportContainer" #REPORT_ATTRIBUTES# id="report_#REGION_STATIC_ID#" summary="">',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2941317862225722)
,p_row_template_name=>'One Column Unordered List'
,p_row_template1=>'<li>#COLUMN_VALUE#</li>'
,p_row_template_before_rows=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<table class="uReportList" #REPORT_ATTRIBUTES# id="report_#REGION_STATIC_ID#" summary="">',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2941624745225722)
,p_row_template_name=>'Search Results Report (SELECT link_text, link_target, detail1, detail2, last_modified)'
,p_row_template1=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<li>',
'<span class="title"><a href="#2#">#1#</a></span>',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2941903633225722)
,p_row_template_name=>'Standard'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<table class="uReportContainer" #REPORT_ATTRIBUTES# id="report_#REGION_STATIC_ID#" summary="">',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2942216722225722)
,p_row_template_name=>'Standard - Alternative'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template3=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="uOddRow">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2942501265225722)
,p_row_template_name=>'Two Column Portlet'
,p_row_template1=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<li>',
'  <span class="uValueHeading">',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2942832052225722)
,p_row_template_name=>'Value Attribute Pairs'
,p_row_template1=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<li>',
'  <span class="uValueHeading">',
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(2943110362225723)
,p_row_template_name=>'Value Attribute Pairs - Left Aligned'
,p_row_template1=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<li>',
'  <label>',
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2884720177187747)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2884806044187748)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2884914044187748)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2885002782187748)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2885100988187748)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2885211157187748)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2947614918225725)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2947705875225725)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2947824540225725)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2947910523225725)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2948011066225725)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2948120245225725)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(2948210487225725)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(2886324422187750)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(2886430816187751)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(2949527351225726)
,p_name=>'Breadcrumb Menu'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(2886831216187753)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(2949706648225726)
,p_popup_icon=>'#IMAGE_PREFIX#f_spacer.gif'
,p_popup_icon_attr=>'alt="#LIST_OF_VALUES#" title="#LIST_OF_VALUES#" class="uPopupLOVIcon"'
,p_page_name=>'winlov'
,p_page_title=>'Search Dialog'
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(2886517295187752)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(2886629654187753)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(2886724385187753)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(2949632731225726)
,p_cal_template_name=>'Calendar'
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(2886916558187756)
,p_theme_id=>26
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(2877128213187731)
,p_error_template=>wwv_flow_api.id(2876609103187729)
,p_printer_friendly_template=>wwv_flow_api.id(2877600088187732)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(2876217106187726)
,p_default_button_template=>wwv_flow_api.id(2885329235187748)
,p_default_region_template=>wwv_flow_api.id(2880613377187740)
,p_default_chart_template=>wwv_flow_api.id(2879005261187739)
,p_default_form_template=>wwv_flow_api.id(2879300055187739)
,p_default_reportr_template=>wwv_flow_api.id(2880613377187740)
,p_default_tabform_template=>wwv_flow_api.id(2880613377187740)
,p_default_wizard_template=>wwv_flow_api.id(2881431904187740)
,p_default_menur_template=>wwv_flow_api.id(2878609945187737)
,p_default_listr_template=>wwv_flow_api.id(2878916328187738)
,p_default_irr_template=>wwv_flow_api.id(2879715558187740)
,p_default_report_template=>wwv_flow_api.id(2882321912187742)
,p_default_label_template=>wwv_flow_api.id(2884914044187748)
,p_default_menu_template=>wwv_flow_api.id(2886324422187750)
,p_default_calendar_template=>wwv_flow_api.id(2886517295187752)
,p_default_list_template=>wwv_flow_api.id(2884407718187746)
,p_default_option_label=>wwv_flow_api.id(2885002782187748)
,p_default_required_label=>wwv_flow_api.id(2885211157187748)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(2949925742225726)
,p_theme_id=>25
...
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(2909327515225707)
,p_error_template=>wwv_flow_api.id(2895031562225701)
,p_printer_friendly_template=>wwv_flow_api.id(2918808891225711)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(2889415368225698)
,p_default_button_template=>wwv_flow_api.id(2948329732225725)
,p_default_region_template=>wwv_flow_api.id(2938418217225721)
,p_default_chart_template=>wwv_flow_api.id(2938418217225721)
,p_default_form_template=>wwv_flow_api.id(2935530260225719)
,p_default_reportr_template=>wwv_flow_api.id(2938418217225721)
,p_default_tabform_template=>wwv_flow_api.id(2938418217225721)
,p_default_wizard_template=>wwv_flow_api.id(2935530260225719)
,p_default_menur_template=>wwv_flow_api.id(2934006945225719)
,p_default_listr_template=>wwv_flow_api.id(2938418217225721)
,p_default_irr_template=>wwv_flow_api.id(2936807950225720)
,p_default_report_template=>wwv_flow_api.id(2941903633225722)
,p_default_label_template=>wwv_flow_api.id(2947824540225725)
,p_default_menu_template=>wwv_flow_api.id(2949527351225726)
,p_default_calendar_template=>wwv_flow_api.id(2949632731225726)
,p_default_list_template=>wwv_flow_api.id(2946714550225724)
,p_default_option_label=>wwv_flow_api.id(2947824540225725)
,p_default_required_label=>wwv_flow_api.id(2948120245225725)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(2950307479232272)
,p_theme_id=>101
,p_theme_name=>'Bootstrap'
,p_ui_type_name=>'DESKTOP'
,p_navigation_type=>'T'
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(2887210554187766)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(2887027506187757)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(2887027506187757)
,p_name=>'Home'
,p_page_mode=>'NORMAL'
,p_step_title=>'Home'
...
,p_step_template=>wwv_flow_api.id(2951116154282641)
...
,p_last_updated_by=>'EHARRIS'
,p_last_upd_yyyymmddhh24miss=>'20140814213324'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(2889415368225698)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
,p_cache_mode=>'NOCACHE'
,p_last_upd_yyyymmddhh24miss=>'20140814211650'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2887523475187772)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(2935530260225719)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2887822893187777)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2887523475187772)
,p_button_name=>'P101_LOGIN'
,p_button_static_id=>'P101_LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(2948329732225725)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2887607509187774)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2887523475187772)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(2947705875225725)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2887714461187776)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2888001522187778)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2887924159187777)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2888216664187778)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2888107997187778)
,p_process_sequence=>10
